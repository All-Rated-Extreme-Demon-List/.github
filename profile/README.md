...
## AREDL Github Org
This Github organization holds the code for the different versions of the AREDL website (frontend & backend), utility repositories/APIs, and discord bots. It has the following repositories:

### Current

-  **[AREDLV3-Frontend](https://github.com/All-Rated-Extreme-Demon-List/AREDLV3-Frontend) (Private)**: Public website with Tanstack Start and a new design.
...
-  **[Thumbnails](https://github.com/All-Rated-Extreme-Demon-List/Thumbnails)**: Utility repo hosting different levels and packs thumbnails displayed on the V3 Frontend site. Uses the [Levels thumbnails Geode mod API](https://geode-sdk.org/mods/cdc.level_thumbnails).
-  **[AREDL-OG](https://github.com/All-Rated-Extreme-Demon-List/aredl-og)**: Small API made for generating Open Graph images for website embeds. Uses Takumi.
...
-  **[AREDL-Staff-Portal](https://github.com/All-Rated-Extreme-Demon-List/AREDL-Staff-Portal) (Private)**: Frontend that was used for staff tasks such as submissions reviewal. Deprecated after said tasks were directly integrated into the public website for users with a staff account.

## Credits
- [Simolater](https://github.com/Simolater): Backend V1, Backend V2, Frontend V2, Deployments
- [Minebox260](https://github.com/Minebox260): AREDL Manager V2, AREDL Manager V3, Frontend V3, Staff Portal, Backend V2, CI/CD
