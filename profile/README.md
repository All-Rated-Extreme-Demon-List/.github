...
-  **[AREDL-Old-Backend](https://github.com/All-Rated-Extreme-Demon-List/AREDL-Old-Backend)**: Currently deployed backend API used by the current website and various geode mods. Available [here](https://api.aredl.net/api), documentation [here](https://api.aredl.net/docs/index.html). Written in Go using the [pocketbase](https://pocketbase.io) framework.
-  **[aredl-backend-v2](https://github.com/All-Rated-Extreme-Demon-List/aredl-backend-v2) (Private)**: WIP Rewrite of the current backend, with PostgreSQL & Rust using the Actix-web framework and the Diesel ORM. Available [here](https://api.aredl.net/v2/api), documentation [here](https://api.aredl.net/v2/docs).
...
-  **[GD-Fisher](https://github.com/All-Rated-Extreme-Demon-List/GD-Fisher)**: "Fishing" discord bot similar to the miso bot fish command, but with AREDL levels instead of fishes.
...
- [sphericle](https://github.com/sphericle): Backend V2, Frontend V3, Staff Portal
